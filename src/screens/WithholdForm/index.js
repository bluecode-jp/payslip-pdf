...
const generateTable1 = (doc, { width, top, left }, tableValues) => {
...
const generateTable2 = (doc, { width, top, left }, tableValues) => {
  doc.setFont('MSMINCHO', 'normal')
...
const generateTable3 = (doc, { width, top, left }, tableValues) => {
  doc.setFont('MSMINCHO', 'normal')
...
const generateTable4 = (doc, { width, top, left }, tableValues) => {
  doc.setFont('MSMINCHO', 'normal')
