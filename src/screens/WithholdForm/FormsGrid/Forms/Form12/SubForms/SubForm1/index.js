            ...
            <div>
              <div className={styles.firstSubrow}>
                ...
                <div>
                  <input
                    type={'text'}
                    value={formValues.form12[index].furigana}
                    onChange={e =>
                      setFormValues(prevState => {
                        const formValues = { ...prevState }
                        formValues.form12[index].furigana = e.target.value
                        return formValues
                      })
                    }
                  />
              ...
              <div className={styles.secondSubrow}>
                ...
                <div>
                  <input
                    type={'text'}
                    value={formValues.form12[index].name}
                    onChange={e =>
                      setFormValues(prevState => {
                        const formValues = { ...prevState }
                        formValues.form12[index].name = e.target.value
                        return formValues
                      })
                    }
                  />
