  ...
  doc.autoTable({
    ...
    body: [
      [
        ...
        formValues.specialDeductions,
        { content: '居住開始年月日 (1回目)', styles: { cellWidth: 15 } },
        {
          content: formValues.startOfResidence1.year,
          styles: { cellWidth: 12 },
        },
        {
          content: formValues.startOfResidence1.month,
          styles: { cellWidth: 12 },
        },
        {
          content: formValues.startOfResidence1.day,
          styles: { cellWidth: 12 },
        },
        {
        ...
        formValues.yearEndBalance1,
      ],
      [
        { content: '住宅借入金等特別控除可能額', styles: { cellWidth: 15 } },
        formValues.specialDeductibleAmount,
        { content: '居住開始年月日 (2回目)', styles: { cellWidth: 15 } },
        {
          content: formValues.startOfResidence2.year,
          styles: { cellWidth: 12 },
        },
        {
          content: formValues.startOfResidence2.month,
          styles: { cellWidth: 12 },
        },
        {
          content: formValues.startOfResidence2.day,
          styles: { cellWidth: 12 },
        },
        {
